...
import{Sphone, SimpleUserOptions, SphoneDelegate} from "./sip/src/platform/web/index"
...
function buildUser1(
 ...
 function init(localVideo:HTMLVideoElement, remoteVideo:HTMLVideoElement, remoteAudio:HTMLAudioElement)
{
...
function makecall(localVideo:HTMLVideoElement, remoteVideo:HTMLVideoElement, remoteAudio:HTMLAudioElement)
{
