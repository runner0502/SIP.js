import { Byer, Infoer, Invitation, Inviter, Messager, Registerer, RegistererState, SessionState, UserAgent } from "../../api/index";
...
export class Sphone {
    ...
    initSession1(session, localVideoControl, remoteVideoControl, remoteAudioControl, referralInviterOptions) {
        ...
        const call1 = new Call(session, localVideoControl, remoteVideoControl, callLogger, this.delegate, remoteAudioControl);
