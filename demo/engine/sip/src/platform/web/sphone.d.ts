...
export declare class Sphone {
     ...
     * @param destination - The target destination to call. A SIP address to send the INVITE to.
     */
    call1(destination: string, localVideoControl: HTMLVideoElement, remoteVideoControl: HTMLVideoElement, remoteAudioControl?: HTMLAudioElement, inviterOptions?: InviterOptions, inviterInviteOptions?: InviterInviteOptions): Promise<void>;
    /**
     * Hangup a call.
...
//# sourceMappingURL=sphone.d.ts.map