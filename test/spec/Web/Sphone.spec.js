// import { Sphone, SimpleUserDelegate, SimpleUserOptions } from "../../../src/platform/web";
// import { Sphone } from '../../../src/platform/web/sphone';

describe('platform/web/Sphone', function() {
//     it('creates instance', function() {
      // var simple = new SIP.Sphone({
      //   media: {
      //     remote: {
      //       audio: {}
      //     }
